    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 justify-between items-center">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 relative z-50"
      ...
      {isMenuOpen && (
        <>
          ...
          {/* Menu Panel */}
          <div className="fixed top-16 left-0 right-0 bg-white dark:bg-gray-800 shadow-lg z-40 md:hidden">
